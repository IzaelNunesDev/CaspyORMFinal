...
class TestConnection:
    ...
    @patch('src.caspyorm.core.connection.Cluster')
    ...
    async def test_execute_async(self):
        ...
        mock_session = MagicMock()
        mock_result = Mock()
        mock_session.execute_async.return_value = FakeFuture(mock_result)
        conn = ConnectionManager()
        conn.async_session = mock_session
...
class TestConnectionSingleton:
    ...
    def test_connection_singleton(self):
        ...
        from src.caspyorm.core.connection import connection as connection2
        assert connection is connection2
    
    @patch('src.caspyorm.core.connection.ConnectionManager.connect')
    ...
    @pytest.mark.asyncio
    @patch('src.caspyorm.core.connection.ConnectionManager.connect_async')
    ...
    @patch('src.caspyorm.core.connection.ConnectionManager.disconnect')
    ...
    @pytest.mark.asyncio
    @patch('src.caspyorm.core.connection.ConnectionManager.disconnect_async')
    ...
    @patch('src.caspyorm.core.connection.ConnectionManager.execute')
    ...
    @pytest.mark.asyncio
    @patch('src.caspyorm.core.connection.ConnectionManager.execute_async')
