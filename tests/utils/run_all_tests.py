...
def run_unit_tests(coverage=False, verbose=False):
    ...
    unit_tests = [
        "tests/unit/core/test_fields.py",
        "tests/unit/core/test_connection.py", 
        "tests/unit/core/test_model.py",
        "tests/unit/core/test_query.py",
        "tests/unit/internal/test_internal_model_construction.py",
        "tests/unit/internal/test_internal_serialization.py",
        "tests/unit/internal/test_query_builder.py",
...
def run_integration_tests(coverage=False, verbose=False):
    ...
    integration_tests = [
        "tests/integration/test_model_relationships.py",
...
def run_cli_tests(coverage=False, verbose=False):
    ...
    cli_tests = [
        "tests/cli/test_general_commands.py",
        "tests/cli/test_basic_commands.py",
        "tests/cli/test_advanced_commands.py",
        "tests/cli/test_error_handling.py",
        "tests/cli/test_integration_commands.py",
        "tests/cli/test_fixes.py"
    ]
